...
namespace Reti.Lab.FoodOnKontainers.Reviews.Api.Services
{
    ...
    public class ReviewService : IReviewService
    {
        ...
        {
            var restaurantReviewsByOrder = await this.reviewsDBContext.RestaurantsReviews.SingleAsync(rst => rst.IdOrder == idOrder);
        ...
        {
            var restaurantReviews = await this.reviewsDBContext.RestaurantsReviews.Where(rw => rw.IdUser == idUser)
        ...
        {
            var restaurantReview = await this.reviewsDBContext.RestaurantsReviews.FirstOrDefaultAsync(rw => rw.IdUser == idUser && rw.IdRestaurant == IdRestaurant);
        ...
        {
            var restaurantReviews = await this.reviewsDBContext.RestaurantsReviews.Where(rw => rw.IdRestaurant == idRestaurant)
                 .Select(rw => ToRestaurantReviewDtO(rw))
                 .ToListAsync();
        ...
        {
            var riderReview = await this.reviewsDBContext.RidersReviews.FirstOrDefaultAsync(rw => rw.IdUser == idUser && rw.IdRyder == idRider);
